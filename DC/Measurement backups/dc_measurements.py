''' DC_M_measurements_v1.py contains functions and classes that can be used to improve DC measurement on 'Ask' 
...
class Lock_OUT:
    ...
    def __init__( self, rack, VI_rack_conversion, signal, frequency, unit = 'Vpk' ):
        '''
        Rack: rack value e.g. SC.rack['dIb']
        VI conversion: conversion factor between V and I (e.g. 1uA/V)
        signal: signal strength
        frequency: frequency for the output
        Unit: Vpk or such
        See: set_lockin in DC_utilities
        '''
        self.rack0 = rack
